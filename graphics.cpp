...
#define LGREY  0x9A9A9A
#define DGREY  0x5A5A5A
...
void draw_img(int u, int v, const char* img)
{
    ...
    for (int i = 0; i < 11*11; i++)
    {
        ...
        else if (img[i] == 'P') colors[i] = PEACH;
        else colors[i] = BLACK;
    }
...
{
    uLCD.line(u, v+6, u+11, v+6, LGREY);
}
...
void draw_game_over()
{
    ...
    uLCD.text_string("GAME", 7, 5, FONT_5X7, YELLOW);
    uLCD.text_string("OVER", 7, 6, FONT_5X7, YELLOW);
}
